...
<Text style={styles.mediumText}>MEDIUM</Text>
     ...
     <TouchableOpacity onPress={()=>router.push('/completedform')} style={{position:'absolute',height:70,width:'100%',backgroundColor:'#2276E3',zIndex:10,bottom:-10,alignItems:'center',justifyContent:'center'}}>
