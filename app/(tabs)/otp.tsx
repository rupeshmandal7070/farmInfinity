...
const Otp = () => {
  ...
  return (
    <View style={{flex:1,backgroundColor:'#fff'}}>
       ...
       <Text style={{fontSize:16,color:'#2276e3'}}>OTP</Text>
         <TextInput  style={{backgroundColor:'#eef5fd',height:50,borderRadius:10,marginTop:5,paddingLeft:10}}/>
       </View>


       <TouchableOpacity onPress={()=>router.push('/profile')} style={{height:60,width:170,alignSelf:'center',backgroundColor:'#ff6d38',borderRadius:30,marginTop:50,justifyContent:'center'}}>
       <Text style={{fontSize:24,textAlign:'center',color:'white'}}>Sign in</Text>
       </TouchableOpacity>

       <View style={{width:'70%',alignSelf:'center',marginTop:20}}>
       <Text style={{fontSize:18,color:'#2276e3',textAlign:'center'}}>Resend OTP</Text>
       </View>
    </View>
  )
}
